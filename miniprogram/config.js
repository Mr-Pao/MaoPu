...
module.exports = {
  ...
  laf_dev_url: 'https://hy87gr.laf.run',
  // 使用私有的腾讯云cos存储，需要url签名
  use_private_tencent_cos: false,

  // 科普页图片
  science_imgs: [
    "https://hy87gr-cat.oss.laf.run/科普1.png",
    "https://hy87gr-cat.oss.laf.run/科普2.png",
    "https://hy87gr-cat.oss.laf.run/科普3.png",
    "https://hy87gr-cat.oss.laf.run/科普4.png",
    "https://hy87gr-cat.oss.laf.run/科普5.png"
  ],

  // 赞赏码图片
  reward_img: "https://hy87gr-cat.oss.laf.run/赞赏码.jpg",
  // 新猫问卷图片
  feedback_wj_img: "https://hy87gr-cat.oss.laf.run/新猫问卷.png",
  // 小程序菊花码图片
  ...
  text: {
    ...
    feedback: {
      ...
      contract_tip: "有关猫猫信息添加、小程序的建议、照片维权、猫猫领养咨询等事项，请联系Pao_Leo",
    },
